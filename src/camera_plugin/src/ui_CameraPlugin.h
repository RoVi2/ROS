...
public:
    ...
    void retranslateUi(QDockWidget *SamplePlugin)
    {
        ...
        _btn0->setText(QApplication::translate("SamplePlugin", "Grab image", 0, QApplication::UnicodeUTF8));
        _btn1->setText(QApplication::translate("SamplePlugin", "move robot", 0, QApplication::UnicodeUTF8));
